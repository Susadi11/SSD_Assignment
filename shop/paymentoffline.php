...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['place_order'])) {
    // Validate CSRF token
    if (!csrf_validate('place_order', $_POST['csrf_token'] ?? null)) {
        csrf_fail();
    }
...
.ordernow button{width: 200px;margin: 20px auto 0;text-align: center;padding: 5px;font-size: 30px;display: block;background: #ff0000;color: #fff;border-radius: 3px;border:none;cursor:pointer;}
</style>
